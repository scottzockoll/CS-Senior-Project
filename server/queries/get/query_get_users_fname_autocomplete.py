...
def query_get_users_fname_autocomplete(firstName: str, offset: int, limit: int = 500):
    """
    Retrieves multiple users given their first name similarity.
    :param str firstName: The first name to compare users by
