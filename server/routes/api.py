...
def register_api_routes(app: Flask):
    ...
    app.route('/api/v1/user/search/email/<string:email>/<int:offset>/<int:limit>', methods=['GET'])(get_users_email_autocomplete)
    app.route('/api/v1/user/search/first-name/<string:firstName>/<int:offset>/<int:limit>', methods=['GET'])(get_users_fname_autocomplete)
    app.route('/api/v1/user/search/last-name/<string:lastName>/<int:offset>/<int:limit>', methods=['GET'])(get_users_lname_autocomplete)
